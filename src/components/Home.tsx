...
import emailIcon from '../assets/icons8-email-52.png'
function Home(){

    return<>
    <div className="addMe" style={{width:'100%',height:'600px',backgroundRepeat:'no-repeat'}} id="Home">
    <div className="row align-items-center d-flex justify-content-center">
       
        <div className="col-md-10">
            <div>
                <p><b>Hi there,I'm <span className="text-danger">Isuru </span>Rathnayaka,</b></p>
                <h1 className="topic1" style={{fontSize:'60px'}}>I build<span className="text-danger"> wonderful</span>  products</h1>
                <h3 className="topic2" style={{fontSize:'40px'}}>Fullstack Developer</h3>
                <p>A undergraduvate who have strong interest in software development and web develeopment.All ways try to become perfect</p>
                <a href="" className="btn btn-danger mb-3">See my work</a>
                <br />
                <a href="https://www.facebook.com/profile.php?id=100085099837455">
                <a href="https://www.facebook.com/profile.php?id=100085099837455" className="jumping-svg">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 24 24" className="me-3">
                ...
                <a href="" className="jumping-svg">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 24 24" className=" me-3">
                    <path d="M 8 3 C 5.239 3 3 5.239 3 8 L 3 16 C 3 18.761 5.239 21 8 21 L 16 21 C 18.761 21 21 18.761 21 16 L 21 8 C 21 5.239 18.761 3 16 3 L 8 3 z M 18 5 C 18.552 5 19 5.448 19 6 C 19 6.552 18.552 7 18 7 C 17.448 7 17 6.552 17 6 C 17 5.448 17.448 5 18 5 z M 12 7 C 14.761 7 17 9.239 17 12 C 17 14.761 14.761 17 12 17 C 9.239 17 7 14.761 7 12 C 7 9.239 9.239 7 12 7 z M 12 9 A 3 3 0 0 0 9 12 A 3 3 0 0 0 12 15 A 3 3 0 0 0 15 12 A 3 3 0 0 0 12 9 z"></path>
                </svg>
                </a>
                <a href="www.linkedin.com/in/isuru-rathnayaka-0b913a270" className="jumping-svg">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 24 24" className="me-3">
                ...
                <a href="https://github.com/IsuruChandikaRathnayaka" className="jumping-svg">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 24 24" className="me-3">
                ...
                <a href="" >
                    <img src={emailIcon} height={40} className="jumping-svg" width={30}></img>
                </a>
